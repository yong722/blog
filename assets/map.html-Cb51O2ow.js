...
<span class="line">            },</span>
<span class="line">    }],</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li><p>实现地图3D效果还可以用geo3D或者map3D，但是我的需求中scatter3D的symbol样式满足不了设计图需求，只有用2D实现，以前使用2D地图实现3D效果的方法又满足不了需求，于是就有了上面的方法</p></li></ul>`,3)]))}const c=n(l,[["render",t],["__file","map.html.vue"]]),p=JSON.parse('{"path":"/blogs/2022/echarts/map.html","title":"echarts地图3D效果&外部阴影","lang":"en-US","frontmatter":{"title":"echarts地图3D效果&外部阴影","date":"2022-07-14T00:00:00.000Z","tags":["echarts"],"categories":[]},"headers":[],"git":{},"filePathRelative":"blogs/2022/echarts/map.md"}');export{c as comp,p as data};
